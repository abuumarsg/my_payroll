...
CREATE TABLE `admin_super`  (
  `id_admin` bigint(25) NOT NULL AUTO_INCREMENT,
  ...
  `update_by` bigint(255) NULL DEFAULT NULL,
...
CREATE TABLE `admin_user`  (
  ...
  `email_verified` int(1) NULL DEFAULT 0,
...
CREATE TABLE `karyawan`  (
  ...
  `create_by` bigint(255) NULL DEFAULT NULL,
  `update_by` bigint(255) NULL DEFAULT NULL,
  `sc_old` int(2) NULL DEFAULT NULL,
  `sisa_cuti` int(255) NULL DEFAULT NULL,
...
INSERT INTO `master_komponen` VALUES (2, 'KMP00002', 'Tunjangan PA', 'rumus', 'variable', '5%', '*', 'data', 'KMP00001', NULL, '1', '1', '2023-11-08 00:01:31', '1', '2023-11-08 00:01:38');
...
INSERT INTO `master_komponen` VALUES (15, 'KMP00015', 'Potongan cuti 1 hari', 'rumus', 'data', 'KMP00004', '+', 'data', 'KMP00003', NULL, '1', '2', '2023-12-07 01:06:07', '2', '2023-12-07 01:06:07');
...
CREATE TABLE `master_rumus_payroll`  (
  `id_rumus` int(12) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `master_rumus_payroll` VALUES (2, 'RMP00002', 'TEST', 'KMP00014', 'KMP00014', '1', '2', '2', '2023-11-24 20:32:20', '2023-11-24 20:32:20');
